<template>
	<view class="tui-list-cell" :class="[
	 ...
	 :hover-class="hover ? 'tui-cell-hover' : ''" :style="{ backgroundColor: backgroundColor, fontSize: size + 'rpx', color: color, padding: padding }"
...
<script>
	export default {
		...
		props: {
			...
			//箭头颜色 传值： white，gray,warning,danger,success(green)
			arrowColor: {
				type: String,
				default: ''
			},
